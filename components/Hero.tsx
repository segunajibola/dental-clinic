...
const badges = [
  { icon: Shield, text: "Certified Clinic" },
  { icon: Star, text: "Top Rated in Lagos" },
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        />
        {/* Floating dots — fixed positions to avoid hydration mismatch */}
        {[
          { top: "8%", left: "12%" },
          { top: "15%", left: "72%" },
          { top: "28%", left: "88%" },
          ...
          <div>
            ...
            >
              ...
              <span className="relative inline-block">
                <span className="text-sky-300">Smile</span>
                <motion.svg
            ...
            >
              Experience world-class dental care in the heart of Lekki, Lagos.
              From cosmetic dentistry to orthodontics — we transform smiles with
              precision, comfort, and care.
            </motion.p>
            ...
            >
              ...
              <a
                href={`https://wa.me/2348100000000?text=${encodeURIComponent("Hello! I would like to book a dental appointment at SmileCraft Dental Clinic.")}`}
                target="_blank"
          ...
          >
            <div className="relative">
              ...
              <div className="flex gap-3">
                ...
                {/* After */}
                <div className="flex-1">
                  <div className="relative rounded-2xl overflow-hidden shadow-2xl border-2 border-sky-400/50">
                    <img
              ...
              <motion.div
                ...
                className="absolute -top-6 -right-6 bg-red-500 text-white rounded-2xl px-4 py-3 shadow-xl"
              >
