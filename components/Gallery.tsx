  ...
  return (
    ...
    >
      <div className="flex h-48">
        {/* Before */}
        <div
          className={`relative flex-1 bg-gradient-to-br ${caseItem.beforeColor} flex items-center justify-center`}
        >
          <svg viewBox="0 0 80 100" className="w-14 h-[4.5rem]" fill="none">
            <path
        ...
        {/* After */}
        <div
          className={`relative flex-1 bg-gradient-to-br ${caseItem.afterColor} flex items-center justify-center`}
        >
          <svg viewBox="0 0 80 100" className="w-14 h-[4.5rem]" fill="none">
            <path
              d="M40 8C26 8 16 18 16 30c0 6 2 11 5 16l5 30c1 4 3 8 6 10 2 1 4 1 5-1 1-1 2-3 3-5l5-10 5 10c1 2 2 4 3 5 1 2 3 2 5 1 3-2 5-6 6-10l5-30c3-5 5-10 5-16 0-12-10-22-24-22z"
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-slate-500 text-lg max-w-xl mx-auto">
            See the difference side by side. These are actual patient results from
