...
const WA_MSG = encodeURIComponent(
  'Hello All Smiles Dental Clinic! 👋 I would like to enquire about your dental services and book an appointment.'
)
...
export default function WhatsAppButton() {
  ...
  useEffect(() => {
    const timer = setTimeout(() => {
      ...
      setTimeout(() => setTooltipOpen(false), 5500)
    }, 2000)
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-3">
      <AnimatePresence>
        {tooltipOpen && (
          <motion.div
            ...
            className="relative bg-white rounded-2xl shadow-xl border border-slate-100 px-4 py-3 max-w-[240px]"
          >
            <button
            ...
            <p className="text-slate-500 text-xs">
              Book at All Smiles or ask anything. We reply instantly!
            </p>
      ...
      <motion.a
        ...
        whileTap={{ scale: 0.95 }}
        className="relative w-14 h-14 bg-green-500 hover:bg-green-600 rounded-full flex items-center justify-center shadow-2xl shadow-green-300/50 transition-colors duration-200"
